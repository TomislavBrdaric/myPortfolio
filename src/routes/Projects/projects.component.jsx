...
import MODERNWEN from "../../assets/modernWeb.jpg";
  ...
  return (
    <Fragment>
      <div className="nav_container_about">
        ...
        <div className="navLinks_container_about">
          <nav className="nav_links_about">
            <NavLink to="/" element=<Home /> className="navLinkAbout">
              HOME
            </NavLink>
            <NavLink to="/about" element=<About /> className="navLinkAbout">
              ABOUT
            </NavLink>
            <NavLink
              to="/projects"
      ...
      <div className="project_container">
        ...
        <div className="page">
          <a href="https://inspiring-crostata-d598ea.netlify.app/#possibility">
            <h3 className="pageText">Modern Website</h3>
            <img className="project" src={MODERNWEN} alt="" />
          </a>
        </div>
        <div className="page">
